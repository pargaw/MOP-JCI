...
# Multi outcome partitioning using Joint Confidence Intervals (MOP-JCI)
class MOP_JCI:
    def __init__(self, estimator_treat_dict=None, estimator_control_dict=None,
                 ...
                 sig_for_split=0.8,
                 seed=None,
                 normalize_S_W_regions=0,sum_var=1, beta =.5):
    ...
    def fit(self, num_outcomes, rows_treat, labels_treat, rows_control, labels_control):
        ...
        for i in range(num_outcomes):
            ...
            if self.conformal_mode == "SCQR_RF":
                est_mean, intv_info, icp, cal_scores, val_est_res  = SCQR (self, i, 
                    [train_rows_treat, val_rows_treat, train_outcome_treat, val_labels_treat],
                    [train_rows_control, val_rows_control, train_outcome_control, val_labels_control])
            else:
        ...
        for col in range(0, column_count):
            ...
            for value in unique_vals:
                ...
                for i in range(num_outcomes):
                    ...
                    # do conformal prediction, get all CIs
                    if self.conformal_mode == "SCQR_RF":
                        tb_est_mean, tb_intv_info, tb_cal_scores, tb_val_set_est_res = SCQR_r (self, node, i, 
                    ...
                    # do conformal prediction, get all CIs
                    if self.conformal_mode == "SCQR_RF":
                        fb_est_mean, fb_intv_info, fb_cal_scores, fb_val_set_est_res = SCQR_r (self, node, i, 
